package com.mkz.data.influxdb.aspect;

import com.mkz.data.influxdb.anno.Insert;
import com.mkz.data.influxdb.anno.Select;
import com.mkz.data.influxdb.core.Executor;
import com.mkz.data.influxdb.core.ParameterHandler;
import com.mkz.data.influxdb.core.ResultSetHandler;
...
public class InfluxDBAspect {
    ...
    public Object select(ProceedingJoinPoint joinPoint, Select select) {
        ...
        // 查询结果
        List<Map<String, Object>> reultList = executor.select(sql, selectAnnotation.bucket());
        // 根据返回类型返回结果
