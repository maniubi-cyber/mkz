package com.mkz.message.domain.dto;

import com.mkz.common.domain.dto.BaseDTO;
...
public class NoticeTemplateDetailDTO extends BaseDTO {
    ...
    @ApiModelProperty("如果是短信模板，列出有关的短信模板")
