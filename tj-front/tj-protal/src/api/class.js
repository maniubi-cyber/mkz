...
export const getUserCurrentPoints = () =>
	request({
		url: `${LEARNING_API_PREFIX}/points/`,
		method: 'get',
	})
// 获取积分商品列表
export const getMallItems = (params) => {
    return request({
        url: `${LEARNING_API_PREFIX}/points-mall-items/page`,
        method: 'get',
		params
    })
}
...
// 根据ID查询积分商品
export const queryPointsItemById = (id) => {
    return request({
        url: `${LEARNING_API_PREFIX}/points-mall-items/${id}`,
        method: 'get'
    })
}
...
export const getMyCollect = (params) =>
	request({
		url: `${LEARNING_API_PREFIX}/collect/page`,
		method: 'get',
		params
	})
// 收藏/取消收藏
export const addMyCollect = (params) =>
	request({
		url: `${LEARNING_API_PREFIX}/collect`,
		method: 'post',
		data:params
	})
//查看该课程是否收藏
export const isCollect = (lessonId) =>
	request({
