package com.mkz.media.storage.minio;

import com.mkz.common.utils.StringUtils;
import com.mkz.media.config.MinioProperties;
...
public class MinioFileStorage implements IFileStorage {
    ...
    @Override
    public com.mkz.media.domain.po.File mergeChunks(String fileMd5, int chunkTotal, String fileName, String chunkFileFolderPath) {
        //找到所有的分块文件
        ...
        try(FileInputStream fileInputStream = new FileInputStream(file)){
            ...
            com.mkz.media.domain.po.File fileInfo = null;
                fileInfo = new com.mkz.media.domain.po.File();
