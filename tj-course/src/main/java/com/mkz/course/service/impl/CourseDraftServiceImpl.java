...
import com.mkz.api.dto.course.CourseDTO;
import com.mkz.api.dto.course.CoursePurchaseInfoDTO;
import com.mkz.api.dto.exam.QuestionBizDTO;
...
import com.mkz.course.constants.CourseConstants;
import com.mkz.course.constants.CourseErrorInfo;
import com.mkz.course.constants.CourseStatus;
import com.mkz.course.domain.dto.CourseBaseInfoSaveDTO;
import com.mkz.course.domain.dto.CoursePageQuery;
import com.mkz.course.domain.po.*;
import com.mkz.course.domain.vo.CourseBaseInfoVO;
import com.mkz.course.domain.vo.CoursePageVO;
import com.mkz.course.domain.vo.CourseSaveVO;
import com.mkz.course.domain.vo.NameExistVO;
import com.mkz.course.mapper.*;
...
public class CourseDraftServiceImpl extends ServiceImpl<CourseDraftMapper, CourseDraft> implements ICourseDraftService {
    ...
    public void upShelf(Long id) {
        ...
        //5.课程上架mq：通过RocketMQ异步解耦，本地消息表保障最终一致性
        localMessageService.sendBusinessMessage(MqConstants.Topic.COURSE_TOPIC, "up", id, "course:up:" + id);
        //6.失效课程缓存（上架后详情/简单信息变更，避免残留旧数据）
        courseService.evictCourseCache(id);
    }
    ...
    public void downShelf(Long id) {
        ...
        //8.下架mq广播：通过RocketMQ异步解耦，本地消息表保障最终一致性
        localMessageService.sendBusinessMessage(MqConstants.Topic.COURSE_TOPIC, "down", id, "course:down:" + id);
    }
